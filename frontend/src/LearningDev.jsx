...
function LearningDev() {
  ...
  return (
    <div className='d-flex flex-column align-items-center pt-4'>
      <h2>Learning and Development Interventions</h2>
      <form className="row g-3 w-50" onSubmit={handleSubmit}>
        <div className='col align-self-center bg-primary mw-100'>
        <div className="col-2">
        ...
        <div className="col-8">
          <label htmlFor="positionTitle" className="form-label">Title of Training Programs</label>
          <input
            type="text"
